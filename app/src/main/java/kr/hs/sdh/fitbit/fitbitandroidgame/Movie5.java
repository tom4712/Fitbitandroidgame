...
public class Movie5 extends YouTubeBaseActivity implements  YouTubePlayer.OnInitializedListener {
    ...
    Thread thread;    YouTubePlayerView youTubeView;
    ImageButton button1 ;
    int num=0;
    Handler handler;
    ImageButton button2 ;
...
//                if(num2>=3){
//
//                    Toast.makeText(getApplicationContext(), "5번 이상 시청하셨습니다",
...
//
//
//                    Toast.makeText(getApplicationContext(), "완료보상으로 5코인이 지급되었습니다!",
//
//                            Toast.LENGTH_LONG).show();
//
//
